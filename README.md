...
This project was part of the *Data Science Nanodegree* with Udacity.  The aim of the project is to develop a recommendation engine for suggesting new articles to the [IBM Watson Community](https://dataplatform.cloud.ibm.com/community?context=wdp) users.
...
# Future Work
Perform Content Based recommendations using NLP methods; start with simple Count Vectorizer to tokenize the article contents.
